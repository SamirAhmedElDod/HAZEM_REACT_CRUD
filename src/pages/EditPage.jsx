...
const EditPage = () => {
  ...
  const getProduct = async () => {
    setIsLoading(true);
    try {
      const response = await axios.get(`https://hazem-crud222.onrender.com/api/products/${id}`);
      setProduct({
  ...
  const updateProduct = async (e) => {
    e.preventDefault();
    try {
      await axios.put(`https://hazem-crud222.onrender.com/api/products/${id}`, product);
